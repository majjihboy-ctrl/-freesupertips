...
// Only these are actually derivable from the real prediction engine
// (home/away/draw win, over 2.5, BTTS — plus whatever an admin manually
// overrides via admin_prediction). Any other category slug gets an
// honest "not available yet" message instead of silently showing the
// full unfiltered list under a misleading heading.
const CATEGORY_FILTERS: Record<string, { bankersOnly?: boolean; filterPrediction?: string }> = {
  banker: { bankersOnly: true },
  ...
  return (
    <div className="pt-24 pb-16 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {config ? (
          <DailyPredictions bankersOnly={config.bankersOnly} filterPrediction={config.filterPrediction} />
        ) : (
          <div className="text-center py-16 text-slate-400 bg-bg-surface rounded-2xl border border-bg-surface-hover">
            This tip category isn't generated by our prediction engine yet — check back soon, or see{' '}
