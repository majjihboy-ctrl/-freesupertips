    ...
    <div className="pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">{category?.replace(/-/g, ' ').toUpperCase()} Tips</h1>
          <p className="text-slate-400">Specialized predictions for {category}</p>
        </div>
        <DailyPredictions />
      </div>
    </div>
